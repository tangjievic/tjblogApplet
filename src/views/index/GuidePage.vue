...
<div class="guidepage">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <a href="javascript:;" class="card-body" @click="goPage('obmod')">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            <p class="text-truncate font-size-14 mb-2">ts</p>
                            <h4 class="mb-0">前端设计模式</h4>
                        </div>
                ...
                <div class="card-body border-top py-3">
                    <div class="text-truncate">
                        <span class="badge badge-soft-success font-size-11">8%</span>
                        <span class="text-muted ml-2">更新进度</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <a class="card-body" @click="goPage('node1')">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            <p class="text-truncate font-size-14 mb-2">JS</p>
        ...
        <div class="col-md-4">
            <div class="card">
                <a class="card-body" @click="goPage('optbase1')">
                    <div class="media">
                        <div class="media-body overflow-hidden">
                            <p class="text-truncate font-size-14 mb-2">JS</p>
